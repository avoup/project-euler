...
const loadScripts = () => {
    const scripts = document.head.querySelector('#scripts');

    for (const problem of problems) {
        if (problem.isChild) continue;
        const script = document.createElement('script');
        script.onload = function () {
            console.log("Script loaded and ready");
        };
        script.src = `problem_${problem.index}.js`;
        scripts.insertAdjacentElement('afterend', script)
    }
}
